...
Pytanie użytkownika: "${userInput}"`;
        ...
        thinkingIndicator?.remove();
        addChatMessage('system', 'Nie udało się przetworzyć Twojego pytania. Może to być chwilowy problem z siecią lub z usługą AI. Spróbuj zadać pytanie ponownie za chwilę.');
    } finally {
